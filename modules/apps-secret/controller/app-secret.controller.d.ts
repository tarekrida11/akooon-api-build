...
import { AppSecretService } from '../service/app-secret.service';
import { Types } from 'mongoose';
import { DeleteAppSecret } from '../dto';
export declare class AppSecretController {
    private service;
    constructor(service: AppSecretService);
    create(dto: CreateAppSecret): Observable<IAppSecret>;
    find(app: string): Observable<IAppSecret>;
    findById(id: Types.ObjectId): Observable<IAppSecret>;
    deleteById(id: Types.ObjectId): Observable<void>;
    delete(dto: DeleteAppSecret): Observable<void>;
}
